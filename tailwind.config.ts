  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Fantasy palette
        "night-indigo": "hsl(var(--night-indigo))",
        "royal-indigo": "hsl(var(--royal-indigo))",
        "mystic-purple": "hsl(var(--mystic-purple))",
        "lavender-border": "hsl(var(--lavender-border))",
        "pink-lilac": "hsl(var(--pink-lilac))",
        ...
        "dark-stroke": "hsl(var(--dark-stroke))",
        "brown-gold-stroke": "hsl(var(--brown-gold-stroke))",
        sidebar: {
